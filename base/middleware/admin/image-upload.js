...
module.exports = function(config) {
	return function(req, res, next) {
		...
		form.onPart = function (part) {
			...
			var file = {
				basename: basename,
				filePath: path.join(config.dir.server.uploads, basename + ext),
				mediumFilePath: path.join(config.dir.server.uploads, basename + '-medium' + ext),
				thumbFilePath: path.join(config.dir.server.uploads, basename + '-thumb' + ext),
				urlPath: path.join('/uploads', basename + ext),
				mediumUrlPath: path.join('/uploads', basename + '-medium' + ext),
				thumbUrlPath: path.join('/uploads', basename + '-thumb' + ext),
				ext: ext,
				uploadDate: new Date(),
				mime: part.mime,
				hash: form.hash,
